...
import static oop.obj_arr.ScoreTeacher.isValidateScore;

public class ScoreMainTeacher {
    public static void main(String[] args) {
        ...
        */
        ...
        ScoreTeacher[] scoreList = new ScoreTeacher[100];
...
//        while (scoreList[scoreList.length - 1] == null) { //배열이 가득차면 반복문 종료
          while (idx != scoreList.length) {
            ...
            ScoreTeacher s = new ScoreTeacher(name, kor, eng, math);
        ...
        for (ScoreTeacher score : scoreList) {
            if (score == null) break;
            score.scoreInfo();
            System.out.println("------------------------------------");
        }
