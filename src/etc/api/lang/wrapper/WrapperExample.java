...
public class WrapperExample {
    public static void main(String[] args) {
        ...
        // boxing: 기본 데이터 타입을 객체 타입으로 변환하는 과정 -> deprecated(java 8 version 이하 사용)
...
//        Boolean v2 = new Boolean(b);
        ...
        // autoboxing: 기본 타입을 자동으로 객체형으로 변환(변수를 그냥 대입하면 됨)
        Integer v1 = a;
        Boolean v2 = false;
        Character v3 = c;
        Double v4 = d;
        ...
        // autoboxing 이후에 wrapper 클래스는 문자열을 기본형으로 변환하는 데 많이 사용합니다.
